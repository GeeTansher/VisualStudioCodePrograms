...
in linked list's insert function may be the specified position add have some flaws like if 0 or last position entered check it.
...
public:
    ...
    void s_pop()
    {
        ...
        {
            cout << endl
                 << "Stack is empty, no element to be poped.";
            cin.get();
            cin.get();
            return;
        }
    ...
    g:
        ...
        g1:
            ...
            cout << endl
                 ...
                 << "2. Dyanamic Queue Implementation" << endl
        ...
        g5:
            ...
            cout << endl
                 ...
                 << "2. Dyanamic Stack Implementation" << endl
                 << "3. Go Back" << endl;
        ...
        g11:
            ...
            cout << endl
                 << "Enter the number of elements in array to be sorted:";
            cin >> a;
            ar = new int[a];
            cout << endl
